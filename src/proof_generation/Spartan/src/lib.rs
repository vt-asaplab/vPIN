...
/// r1csproof
pub mod r1csproof;
/// public random module
pub mod random;
/// public scalar module
pub mod scalar;
/// public sparse_mlpoly module
pub mod sparse_mlpoly;
mod sumcheck;
/// public timer module
pub mod timer;
/// public transcript module 
pub mod transcript;
mod unipoly;
...
impl Assignment {
  ...
  pub fn pad(&self, len: usize) -> VarsAssignment {
...
pub struct SNARK {
  ...
  ///
  pub inst_evals: (Scalar, Scalar, Scalar),
  ///
  pub r1cs_eval_proof: R1CSEvalProof,
}
